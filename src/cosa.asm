...
MYSIZ	EQU	128			; number of bytes to allocate
        ...
        DEFW	$INIT			; ROM extension initialize
        DEFW	0			; ROM extension BASIC statement handler
        DEFW	0			; ROM extension BASIC device handler
        DEFW	0			; ROM extension BASIC program pointer
        DEFS	6,0			; ROM extension reserved
